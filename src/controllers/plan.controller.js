...
//     const { data, error } = await supabase
//       .from("plans")
//       .select("id, name, website_url, country, language, ga_property_id, created_at, tier")
//       .eq("user_id", userId)
...
//     const { data, error } = await supabase
//       .from("plans")
//       .select("id, name, website_url, country, language, created_at, tier, pipeline_status") // ✅ added
//       .eq("id", id)
//       .eq("user_id", userId)
//       .single();
